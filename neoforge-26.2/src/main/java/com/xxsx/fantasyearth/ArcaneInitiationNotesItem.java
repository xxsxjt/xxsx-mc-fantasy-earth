...
public class ArcaneInitiationNotesItem extends Item {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        player.sendSystemMessage(Component.translatable(learned
                        ? "message.fantasy_earth.arcane_notes.learned"
                        : "message.fantasy_earth.arcane_notes.already_learned")
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> lines, TooltipFlag flag) {
        lines.accept(Component.translatable("tooltip.fantasy_earth.arcane_initiation_notes").withStyle(ChatFormatting.LIGHT_PURPLE));
        lines.accept(Component.translatable("tooltip.fantasy_earth.arcane_initiation_notes.use").withStyle(ChatFormatting.GRAY));
    }
}
