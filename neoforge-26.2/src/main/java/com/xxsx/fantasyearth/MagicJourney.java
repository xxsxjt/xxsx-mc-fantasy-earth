...
public final class MagicJourney {
    public static final String DATA_KEY = "earth_arcana.magic_journey_mask";
    ...
    public enum Milestone {
        ...
        public String translationKey() {
            return "journey.fantasy_earth.milestone." + path;
        }

        public String nextKey() {
            return "journey.fantasy_earth.next." + path;
        }
    }
}
