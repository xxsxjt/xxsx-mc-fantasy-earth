...
public class MagicMachineJeiCategory implements IRecipeCategory<MagicMachineBlock.Recipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.fantasy_earth.machine", Component.translatable(kind.displayNameKey()));
    }
    ...
    public void draw(MagicMachineBlock.Recipe recipe, IRecipeSlotsView slots, GuiGraphicsExtractor g, double mouseX, double mouseY) {
        ...
        g.text(font, Component.translatable("jei.fantasy_earth.process." + kind.blockId()), 52, 29, processColor());
        g.text(font, ">", 78, 29, 0xFFE8DFAF);
        g.text(font, Component.translatable("jei.fantasy_earth.field", recipe.minField()), 4, 50, 0xFF80D0C8);
