...
public class MagicMachineBlockEntity extends BaseContainerBlockEntity {
    ...
    public MagicMachineBlockEntity(BlockPos pos, BlockState state) {
        super(FantasyEarth.MAGIC_MACHINE_BLOCK_ENTITY.get(), pos, state);
    }
    ...
    public enum RedstoneMode {
        ALWAYS(0, "screen.fantasy_earth.redstone.always", "screen.fantasy_earth.redstone.always.desc"),
        REQUIRE_SIGNAL(1, "screen.fantasy_earth.redstone.require_signal", "screen.fantasy_earth.redstone.require_signal.desc"),
        REQUIRE_NO_SIGNAL(2, "screen.fantasy_earth.redstone.require_no_signal", "screen.fantasy_earth.redstone.require_no_signal.desc");
