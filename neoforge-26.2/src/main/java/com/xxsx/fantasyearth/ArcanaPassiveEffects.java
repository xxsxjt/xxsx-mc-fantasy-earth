...
public final class ArcanaPassiveEffects {
    private static final String XUANHUAN_MODID = "xuanhuan_earth";
    private static final String LEGACY_XUANHUAN_MODID = "earth_online_xuanhuan";
    private static final boolean XUANHUAN_PRESENT = ModList.get().isLoaded(XUANHUAN_MODID)
            || ModList.get().isLoaded(LEGACY_XUANHUAN_MODID);
