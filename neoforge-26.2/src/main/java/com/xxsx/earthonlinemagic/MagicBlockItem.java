...
public class MagicBlockItem extends BlockItem {
    ...
    public MagicBlockItem(Block block, Properties properties, String hintKey) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> lines, TooltipFlag flag) {
        ...
        lines.accept(Component.translatable("tooltip.earth_online_magic.block.route").withStyle(ChatFormatting.GRAY));
    }
}
